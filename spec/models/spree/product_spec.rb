...
describe Spree::Product do
  ...
  describe 'Instance Methods' do
    ...
    describe '#ordered_option_types' do
      before { FactoryBot.create_list(:product_option_type, 2, product: product) }
    ...
    describe '#variants_option_value_details' do
      before do
        @option_type = FactoryBot.create(:product_option_type, product: product).option_type
        variant1, variant2 = FactoryBot.create_list(:variant, 2, product: product)
        option_value1, option_value2 = FactoryBot.create_list(:option_value, 2, option_type: @option_type)
